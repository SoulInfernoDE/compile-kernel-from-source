...
echo ''
echo ''
echo  $(green 'Kernel Pull Merge Script v1.01 for generic builds')
echo ''
...
echo $(red ''$CPATH'')
echo ''
read -p " $(italyell 'Which kernel version do you want to compile?') example: $(italyell '6.10.8') -->> " KERNEL_VERSION
echo ''
...
echo ''
wget 'https://raw.githubusercontent.com/SoulInfernoDE/compile-kernel-from-source/refs/heads/v6.x/nogui/.config-fragment'
echo $(green 'DONE!')
echo ''
echo ''
echo $(blue ''$CPATH'/kernel/.config-fragment') '<<----'
echo ''
cat './.config-fragment'
echo ''
echo ''
...
echo $(italyell 'Merge config file  .config-fragment into the main '$CPATH'/kernel/.config file')
